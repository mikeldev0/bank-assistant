...
with tempfile.TemporaryDirectory() as directory:
    ...
    for i in range(100):
        ...
        a = store.propose(
            ...
            Proposal(
                ...
                amount_cents=100,
                concept="Synthetic benchmark",
                idempotency_key=f"benchmark-{i}",
            ),
        )
    ...
    report = {
        "scope": "Local SQLite proposal + confirmation + simulated execution, excludes HTTP/LLM",
        ...
        "execution_events_for_retried_action": sum(
            e["event"] == "executed" for e in store.get("benchmark", a["id"])["audit"]
        ),
    }
